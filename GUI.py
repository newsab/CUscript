...
startBtn = Button(text="Starta", width=20, height=2, bg=frameColor, fg=bgColor, command=clickStartBtn)

pmuLbl = Label(text="Sätt PMU Frekvens", bg=bgColor, fg=textColor)
pmuEnt = Entry(bg=frameColor,fg=textColor)
pmuBtn = Button(text="Spara och starta", width=20, height=2, bg=frameColor, fg=bgColor, command=clickPmuBtn)

ptuLbl = Label(text="Sätt PTU Frekvens", bg=bgColor, fg=textColor)
ptuEnt = Entry(bg=frameColor,fg=textColor)
ptuBtn = Button(text="Spara och starta", width=20, height=2, bg=frameColor, fg=bgColor, command=clickPtuBtn)

rbuLbl = Label(text="Starta RBU", bg=bgColor, fg=textColor)
rbuBtn = Button(text="Starta", width=20, height=2, bg=frameColor, fg=bgColor, command=clickRbuBtn)

grafBtn = Button(text="Visa Graf", width=20, height=2, bg=frameColor, fg=bgColor, command=clickGrafBtn)
graf3dBtn = Button(text="Visa 3D Graf", width=20, height=2, bg=frameColor, fg=bgColor, command=clickGraf3dBtn)
