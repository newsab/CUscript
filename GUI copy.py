...
def createLiveFig():
    ...
    canvasLive.get_tk_widget().grid(row=0, column=2)
...
frame = ScrollableFrame(win, height=winHeight, width=winWidth)


tbMeasure = Text(frame.scrollable_frame, bg=frameColor, fg=textColor, width=87)

tbOthers = Text(frame.scrollable_frame, bg=frameColor, fg=textColor, width=48)

startLbl = Label(frame.scrollable_frame, text="", bg=bgColor, fg=textColor)

startBtn = Button(frame.scrollable_frame, text="Starta mätning", width=15, height=2,
                bg=frameColor, fg=textColor, command=clickStartBtn)

pmuBtn = Button(frame.scrollable_frame, text="Starta PMU", width=15, height=2,
                bg=frameColor, fg=textColor, command=clickPmuBtn)

fqEnt = Entry(frame.scrollable_frame, bg=frameColor, fg=textColor)

rbuBtn = Button(frame.scrollable_frame, text="Start om RBU", width=15, height=2,
                bg=frameColor, fg=textColor, command=clickRbuBtn)
...
posLonLbl = Label(frame.scrollable_frame, text="", bg=frameColor, fg=textColor)
posLatLbl = Label(frame.scrollable_frame, text="", bg=frameColor, fg=textColor)
posAltLbl = Label(frame.scrollable_frame, text="", bg=frameColor, fg=textColor)

fixStatusLbl = Label(frame.scrollable_frame, text="", bg=frameColor, fg=textColor)

posBtn = Button(frame.scrollable_frame, text="Ta ut AUT position", width=15, height=2,
                bg=frameColor, fg=textColor, command=clickPosBtn)
